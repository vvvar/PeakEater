...
namespace gui
{
    ...
    LevelMeterComponent::LevelMeterComponent (
        ...
        : juce::Component(), mName (name), mMeterTimer (std::bind (&LevelMeterComponent::onTimerTick, this)), mTicks (ticks), mLevelMeter (levelMeter), mRange (-36.0f, 0.0f, 0.1f, 1.0f), mSmoothedGain (levelMeter->getDecibels()), mLabel()
    {
