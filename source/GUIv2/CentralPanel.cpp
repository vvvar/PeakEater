...
CentralPanel::CentralPanel (std::shared_ptr<juce::AudioProcessorValueTreeState> parameters,
    ...
    : juce::Component(), mClipMeter (parameters, levelMetersPack, ticks), mControlPanel (parameters, levelMetersPack),
      mLinkingPanel (parameters), mAnalyserComponent (parameters, levelMetersPack), mScalingSwitch (ticks)
{
