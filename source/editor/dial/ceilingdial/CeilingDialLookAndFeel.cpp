...
CeilingDialLookAndFeel::CeilingDialLookAndFeel(std::shared_ptr<processor::LevelMeter<float>> inputMeter,
...
void CeilingDialLookAndFeel::drawProgress(juce::Graphics& g, float value, juce::Colour const&& colour, int x, int y, int width, int height,
