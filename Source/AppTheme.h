...
// Osciloscope
static const auto OSCBackgroundColour = AppColors::V2::TiffanyBlue;
static const auto OSCWaveColour = AppColors::V2::Powder;
static const auto OSCBorderColour = AppColors::V2::Jet;
